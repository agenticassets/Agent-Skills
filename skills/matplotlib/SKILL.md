---
name: matplotlib
description: Use when you need fine-grained control over every plot element, creating novel plot types, custom visualizations, or integrating with specific scientific workflows requiring matplotlib.
triggers:
  - matplotlib
  - plot
  - visualization
