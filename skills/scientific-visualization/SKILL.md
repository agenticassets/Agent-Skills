...
description: Use when creating publication-ready journal submission figures requiring multi-panel layouts, significance annotations, error bars, colorblind-safe palettes, and specific journal formatting.
triggers:
  - publication figure
  - journal figure
  - multi-panel plot
